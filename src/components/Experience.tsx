              ...
              >
                ...
                <div className={`w-full md:w-1/2 mb-8 md:mb-0 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                  ...
                  >
                    ...
                    {exp.technologies && (
                      <div className="mt-4 pt-4 border-t border-primary-100 dark:border-primary-600">
                        <div className="flex flex-wrap gap-2 justify-center">
                          {exp.technologies.map((tech, i) => (
                            <span 
                              key={i} 
                              className="inline-block px-3 py-1 bg-primary-100 dark:bg-primary-600 text-primary-500 dark:text-primary-200 text-xs font-medium rounded-full"
                            >
                              {tech}
                            </span>
                          ))}
                ...
                {/* Timeline dot */}
                <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 w-8 h-8 rounded-full bg-accent-500 shadow-md items-center justify-center z-10">
